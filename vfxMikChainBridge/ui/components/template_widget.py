...
class TemplateGlobalVariablesListWidget(QListWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.variable_1 = TemplateGlobalVariableWidget('ASSET_TYPE', 'character', 'str')
        self.variable_2 = TemplateGlobalVariableWidget('ASSET_NAME', 'blackwolf', 'bool')
        self.variable_3 = TemplateGlobalVariableWidget('TASK', 'mod', 'str')
...
class TemplateWidget(QWidget):
    def __init__(self, name, parent=None):
        ...
        self.btn_template_title = QPushButton(name)
        ...
        self.h_layout_header.addWidget(self.btn_template_title)
        ...
        # self.list_widget_global_variable = TemplateGlobalVariablesListWidget()
